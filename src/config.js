...
export const VEHICLES = {
  ...
  capsule: {
    ...
    points: [
      { x: -14, y: 14, radius: 9, role: "baseLeft" },
      { x: 14, y: 14, radius: 9, role: "baseRight" },
      { x: 0, y: -18, radius: 11, role: "nose" },
      { x: 0, y: 0, radius: 6, role: "seat" },
      { x: 0, y: -12, radius: 5, role: "head" },
    ],
    constraints: [
      { a: 0, b: 1, length: 28, stiffness: 1 },
      { a: 0, b: 2, length: 35, stiffness: 0.95 },
      { a: 1, b: 2, length: 35, stiffness: 0.95 },
      { a: 0, b: 3, length: 20, stiffness: 0.8 },
      { a: 1, b: 3, length: 20, stiffness: 0.8 },
      { a: 3, b: 4, length: 12, stiffness: 0.8 },
      { a: 2, b: 4, length: 8, stiffness: 0.75 },
    ],
    mass: 1,
    traction: 0.9,
    crashSpeed: 1100,
