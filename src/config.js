...
export const VEHICLES = {
  ...
  bike: {
    ...
    constraints: [
      { a: 0, b: 1, length: 48, stiffness: 1 },
      { a: 0, b: 2, length: 31, stiffness: 0.96 },
      { a: 1, b: 2, length: 31, stiffness: 0.96 },
      { a: 0, b: 3, length: 22, stiffness: 0.95 },
      { a: 2, b: 3, length: 8, stiffness: 0.9 },
      { a: 3, b: 4, length: 27, stiffness: 0.88 },
      { a: 4, b: 5, length: 17, stiffness: 0.84 },
      { a: 5, b: 1, length: 31, stiffness: 0.88 },
      { a: 3, b: 5, length: 19, stiffness: 0.82 },
      { a: 2, b: 5, length: 13, stiffness: 0.82 },
    ],
    mass: 0.92,
    traction: 0.94,
    crashSpeed: 980,
